package cars 
{
	...
	public class Truck2Trolley2 extends tdCarBody
	{
				
		private var carSkin:Truck2Trolley2Skin = new Truck2Trolley2Skin();
		...
		public function Truck2Trolley2 () 
		{
			super();
		}
		...
		public function init(stageParam:Stage)
		{
			...
			var rectangle:qb2Body = qb2Stock.newRectBody(new amPoint2d(0, 0), carSkin.width, carSkin.height,300);
			...
			//var circle:qb2Body = qb2Stock.newCircleBody(new amPoint2d(0, 250), 25, 120);
		...
		private function addTires()
		{
			...
			var leftSideX:Number = -47;
			var rightSideX:Number = 47;
			
			var frontY:Number = 53;
			var backY:Number =  87;
