package cars 
{
	...
	public class Truck1Head extends tdCarBody
	{
		
		//private var playerCar:tdCarBody = new tdCarBody();
		
		private var carSkin:Truck1HeadSkin = new Truck1HeadSkin();
		...
		private function addTires()
		{
			...
			var firstY:int = -47.85;
			var secondY:int = 19.65;
			var thirdY:int = 53.15;
			...
			curve.addEntry(3000, 220);
			curve.addEntry(4000, 245);
