package cars 
{
	...
	public class Truck1Trolley extends tdCarBody
	{
				
		private var carSkin:Truck1TrolleySkin = new Truck1TrolleySkin();
		...
		public function init(stageParam:Stage)
		{
			...
			var circle:qb2Body = qb2Stock.newCircleBody(new amPoint2d(0, 90), 25, 70);
		...
		private function addTires()
		{
			...
			var leftSideX:Number = -48;
			var rightSideX:Number = 48;
			
			var frontY:Number = 89;//-20.75;
			var backY:Number =   122;
