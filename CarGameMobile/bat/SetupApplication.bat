...
:: Android packaging
set AND_CERT_NAME="CarGameMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CarGameMobile.p12
...
set IOS_PROVISION=cert\CarGameMobile.mobileprovision
...
set APP_ID=air.CarGameMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=CarGameMobile
