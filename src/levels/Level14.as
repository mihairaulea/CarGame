package levels
{
	...
	public class Level14 extends Level
	{
		...
		public function Level14(stage:Stage, bustCallback:Function, greatCallback:Function,showFeedbackScreen:Function)
		{
		...
		{	
			...
			placeHorizontalBarrel(0, 1604.25);
			
			placeParkingSpotBigTruck( -421.6, -1.9, RAD_90);
			...
			simpleCar.position = new amPoint2d( 767.9, 1060.85);
